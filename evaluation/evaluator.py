...
Quality（完成度）: 0.8-1.0=明確・一貫・使用可能 / 0.5-0.7=構造はあるが欠落 / 0.0-0.4=不明瞭
Logic（論理性）: 0.8-1.0=矛盾なし・根拠あり / 0.5-0.7=根拠不足・飛躍 / 0.0-0.4=矛盾
Creativity（新規性）: 0.8-1.0=既存と明確に異なる / 0.5-0.7=組み合わせだが新観点 / 0.0-0.4=焼き直し
Value（価値）: 0.8-1.0=必要性・影響力・継続性が高い / 0.5-0.7=必要だが不確か / 0.0-0.4=確認できない
Risk（リスク）: 0.8-1.0=失敗影響大・実現可能性低 / 0.5-0.7=部分的リスク / 0.0-0.4=リスク限定的
